          ...
          <div className="col-lg-8 content-area order-lg-2">
                                ...
                                <div className="ttm-service-single-content-area">
                                    ...
                                    <div className="ttm-service-description mt-40">
                                        ...
                                        <p>Drilling and well services encompass the essential processes of extracting oil and gas from underground reservoirs. They involve exploration, construction, production optimization, and maintenance interventions to ensure efficient and sustainable resource extraction. These services require expertise, advanced technology, and a commitment to safety and environmental stewardship.</p>
                                        <div className="row">
                                                ...
                                                <div className="featured-icon-box icon-align-before-content icon-ver_align-top mr-50 mr-md-0 mt-20">
                                                    ...
                                                    <div className="featured-content">
                                                        ...
                                                        <div className="featured-desc">
                                                            <p>Utilizing advanced techniques to locate potential reservoirs.</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="col-lg-6 col-md-6 col-sm-6">
                                                ...
                                                <div className="featured-icon-box icon-align-before-content icon-ver_align-top mr-50 mr-md-0 mt-20">
                                                    ...
                                                    <div className="featured-content">
                                                        ...
                                                        <div className="featured-desc">
                                                            <p>Building wells with casing and cementing for stability.</p>
                                                        </div>
                                                    </div>
                                                </div>{/* featured-icon-box end */}
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-6">
                                                ...
                                                <div className="featured-icon-box icon-align-before-content icon-ver_align-top mr-50 mr-md-0 mt-20">
                                                    ...
                                                    <div className="featured-content">
                                                        ...
                                                        <div className="featured-desc">
                                                            <p> Optimizing output through techniques like fracking and stimulation.</p>
                                                        </div>
                                                    </div>
                                                </div>{/* featured-icon-box end */}
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-6">
                                                ...
                                                <div className="featured-icon-box icon-align-before-content icon-ver_align-top mr-50 mr-md-0 mt-20">
                                                    ...
                                                    <div className="featured-content">
                                                        ...
                                                        <div className="featured-desc">
                                                            <p>Conducting interventions to ensure ongoing well performance.</p>
                                                        </div>
                                                    </div>
                                                </div>{/* featured-icon-box end */}
                                            </div>
