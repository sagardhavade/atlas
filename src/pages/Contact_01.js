          ...
          <div className='container'>
            ...
            <div className='row'>
              ...
              <div className='col-lg-6'>
                <iframe height='530' width='100%' src='https://www.google.com/maps/d/embed?mid=1nJNCCAS0hOULRr10hRRcstuu_8D7jdQ&ehbc=2E312F&noprof=1' />
              </div>
              <div className='col-lg-6'>
            ...
            <div className='row'>
              <div className='col-lg-12'>
                <div className='d-md-flex align-items-center justify-content-between'>
                  ...
                  <a className='ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-border ttm-btn-color-white' href={process.env.PUBLIC_URL + '/contact_01'}>Hiring Now!</a>
                </div>
              </div>
            </div>
          </div>
