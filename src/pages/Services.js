    ...
    render() {
        ...
        return (
            <div className="site-main">
                        ...
                        <Slider className="row slick_slider slick-arrows-style2 pt-20 mb_10" {...slick_slider} slidesToShow={2} rows={2}
                                ...
                                <div className="featured-imagebox featured-imagebox-services style1">
                                    ...
                                    <div className="featured-content">
                                        <div className="featured-title">
                                            <h3><a href={process.env.PUBLIC_URL + '/services_details'}>DRILLING & WELL
                                                SERVICE</a></h3>
                                        </div>
                            ...
                            <div className="col-md-12">
                                ...
                                <div className="featured-imagebox featured-imagebox-services style1">
                                    {/* featured-thumbnail */}
                                    <div className="featured-thumbnail">
                                        <img className="img-fluid" src="images/Service/2.png" alt="image" />
                                    </div>{/* featured-thumbnail end */}
                                    <div className="featured-content">
                                        <div className="featured-title">
                                            <h3><a href={process.env.PUBLIC_URL + '/services_details'}>MARINE
                                                SERVICE</a></h3>
                                        </div>
                                        <div className="featured-desc">
                            ...
                            <div className="col-md-12">
                                ...
                                <div className="featured-imagebox featured-imagebox-services style1">
                                    {/* featured-thumbnail */}
                                    <div className="featured-thumbnail">
                                        <img className="img-fluid" src="images/Service/3.png" alt="image" />
                                    </div>{/* featured-thumbnail end */}
                                    <div className="featured-content">
                                        <div className="featured-title">
                                            <h3><a href={process.env.PUBLIC_URL + '/services_details'}>DREDGING
                                                SERVICE</a></h3>
                                        </div>
                                        <div className="featured-desc">
                            ...
                            <div className="col-md-12">
                                ...
                                <div className="featured-imagebox featured-imagebox-services style1">
                                    {/* featured-thumbnail */}
                                    <div className="featured-thumbnail">
                                        {/* <img className="img-fluid" src="images/Service/1.png" alt="image" /> */}
                                    </div>{/* featured-thumbnail end */}
                                    <div className="featured-content">
                                        <div className="featured-title">
                ...
                {/* cta-section */}
                <section className="ttm-row cta-section bg-img7 bg-theme-DarkColor ttm-bg ttm-bgimage-yes text-theme-WhiteColor clearfix" style={{ backgroundImage: 'url("images/Service/getintouch.png")' }}>
